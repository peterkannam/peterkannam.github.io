...
As a member of the *Superfund Technical Assessment and Response Team* I specialize in quickly establishing effective air monitoring networks during environmental disasters. This involves designing and deploying air monitoring networks of continuous monitors, instantaneous monitors, and associated telemetry equipment based on site-specific monitoring goals, plume characteristics, and environmental conditions. 

I am also experienced in processing and analyzing the air quality data generated by monitoring networks. My work often includes performing different types of time series analysis on monitoring data, using spatial variation in monitors to characterize plume movement, and communicating results to expert and lay audiences using figures, tables, and text. 


### Project Highlight: Conyers, GA BioLab Fire


I was the field team lead at the site of a dynamic Chlorine fire, in charge of air monitoring activities. During my time on site, I established real-time data flows by deploying USEPA ['Viper'](https://response.epa.gov/site/site_profile.aspx?site_id=5033) telemetry equipment and recommend updates to the air monitoring network on site based on metrological data and historical readings. Additionally, I developed a technique to record mobile continuous readings during significant plume events, providing data that was more comparable to relevant screening levels than was previously being recorded. 
